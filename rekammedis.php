<?php 
include "koneksi.php";
$query = $koneksi->query("SELECT * FROM `medis`");
...
<div class="container">
<p>
<a class="btn btn-primary my-lg-3" data-toggle="collapse" href="#" role="button" aria-expanded="false" aria-controls="collapseExample">
    Poli Umum
  </a>
  <a class="btn btn-primary" href="#" role="button">Poli Hati</a>
  <a class="btn btn-primary" href="#" role="button">Poli Gigi</a>
  <a class="btn btn-primary" href="#" role="button">Poli Jantung</a>
...
<?php
    $ambil=mysqli_query ($koneksi,"select * from medis");
